...
function NavBar() {
  return (
    <div className="flex w-[100%] h-[70rem] bg-white justify-center absolute top-0">
      <nav className="w-[80%] flex  justify-between items-center font-['Roboto']">
        <ul className="flex">
        ...
        <div className="w-[150rem] h-[40rem] bg-[#6bbf59] rounded-[60rem] text-[15rem] flex items-center justify-center">
          <span className="mr-[13rem]">Contact Us</span>{" "}
